...
public class Alpha1740224170 extends AlphaAdapter{
	public String getName(){return "xxxxx";}; //姓名
	public String getSID(){return "xxxxxxx";};  //学号
	public String getDept(){return "xxxxxxx";}; //系科
	public String getDesc(){
		return "统计赢法和得分策略：111遍历全棋盘找出4个方向能赢的赢法数组，根据在该赢法数组上连子数来得分，从而让电脑找出最佳下棋位子";
		};//策略描述
